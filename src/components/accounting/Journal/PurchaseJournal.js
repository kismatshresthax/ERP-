...
const AccountRow = (props) => {
  ...
  // const data1=props.editdata
  // console.log(data1.dr_cr)
...
export default function PurchaseJournal(props) {
  const userSessionContext = React.useContext(UserSessionContext);
  ...
  const [journalname, setjournalname] = useState("Purchase Voucher");
  ...
  await  axios
      ...
      .then((res) => {
        if (res.data.status_code === 401) {
          ...
          var trans =
            "PV" + companyFiscalyear + "/" + Date1 + "/" + res.data.msg;
        ...
        <Grid item lg={12} md={12} xs={12}>
          <Card variant="outlined">
            <CardHeader
              ...
              title={"Purchase Voucher: " + journalVoucherId.toString()}
...
<CardHeader
      ...
      <Card variant="outlined">
        ...
        <CardContent>
          <div class="input-group journal-tab3">
            <div class="input-group-prepend">
              <span class="input-group-text" style={{ paddingLeft: "0" }}>
                Narration
              </span>
            </div>
            <textarea
