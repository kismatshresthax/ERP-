...
//import CreateCOAPage from "./CreateCOAPage";
import COAForm from "../COAForm";
//import { ConstructionOutlined, OndemandVideoTwoTone } from "@mui/icons-material";
...
export default function PettyCashJournal(props) {
  const userSessionContext = React.useContext(UserSessionContext);
  ...
  const [journalname, setjournalname] = useState("Petty Cash Voucher");
  ...
  //const [transactionid, setTransactionid] = React.useState(() =>Math.floor(100000 + Math.random() * 900000).toString());
   ...
   await axios
      ...
      .then((res) => {
        if (res.data.status_code === 401) {
          ...
          var trans =
            "PC" + companyFiscalyear + "/" + Date1 + "/" + res.data.msg;
  ...
  return (
    ...
    >
        ...
        <Grid item lg={12} md={12} xs={12}>
          <Card variant="outlined">
            <CardHeader
              ...
              title={"Petty Cash Voucher : " + journalVoucherId.toString()}
      ...
      <Card variant="outlined">
        ...
        <CardContent>
          <div class="input-group journal-tab4">
