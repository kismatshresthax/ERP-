...
export default function ReceiptForm(props) {
 ...
 // const [values, setValue] = React.useState(new Date());
  ...
  const [journalname, setjournalname] = useState("Receipt Voucher");
  ...
  await axios.get(`${config.APP_CONFIG}/Account/LedgerReport/api/${accountingDate}/${companyId}`, {
    ...
    .then((res) => {
      if (res.data.status_code === 401) {
        ...
        var trans="RV"+companyFiscalyear +"/"+Date1+"/"+res.data.msg;
...
//const trans="JV"+companyFiscalyear +"/"+Date1+"/"+serial;
    ...
    } else if (journalname === "" || journalVoucherId === "" || remarks === "" || receiptNo==="") {
        ...
        <Grid item lg={12} md={12} xs={12}>
          <Card variant="outlined">
            <CardHeader
              ...
              title={"Receipt Voucher : " + journalVoucherId.toString()}
