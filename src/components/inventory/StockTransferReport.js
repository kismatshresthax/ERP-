...
//         const products = records.filter((item) => format(new Date(item.transferDate),"yyyy/MM/dd") === date);
//         return (
//           <div key={date}>
//                <h3>Transfer Date: {format(new Date(date), "yyyy/MM/dd").toString()}</h3>
...
//                    <td style={{verticalAlign:"middle",width:"300px"}}>{i.productName}</td>
