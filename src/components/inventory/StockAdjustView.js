...
function StockAdjustView(props) {
   ...
   const companyContext = React.useContext(CompanyContext);
    ...
    const load_table =  () => {
      ...
      axios
        .get(`${config.APP_CONFIG}/Inventory/stockAdjust/Report/api/${props.data.referenceId}`, fig)
        .then((res) => {
          if (res.data.status_code === 200) {
            // console.log(res.data.msg);
            setRecords(res.data.msg);
            setNote(res.data.msg.note);
...
<div className="jreportPage">
  ...
  <div className="reportHeader">
    ...
    <p className="companyReport"> Product Adjust Details</p>
