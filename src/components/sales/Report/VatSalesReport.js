...
export default function VatSalesReport(props) {
  ...
  const handleSubmit = async(e) => {
   ...
   await axios
      .get(
        `${config.APP_CONFIG}/Sales/SalesDetails/api/${companyId}/${dateFrom}/${dateTo}`,
    ...
    axios
      .post(`${config.APP_CONFIG}/Sales/SalesReturnData/api/byDate`, _data, { headers: { Authorization: userSessionContext.token, }, })
      .then((res) => {
...
const ReportComponent=()=>{
  return (
    ...
    <div>
       <ReportHeader title="Vat Sales Register"/>
    ...
    >
      ...
      {records.length !== 0 ? (
        <div>
          ...
          render={({ history }) => (
            <Controls.Button
              text="Back to Report page"
              variant="outlined"
              startIcon={<ArrowBackIcon />}
              className="addbtn"
              onClick={() => {
                //window.print();
                history.push(`/reports/salesreports`);
              }}
            />
          )}
        /> */}
          ...
          <div ref={componentRef} className="salesReport">
            <div className="reportPage">
              <div className="reportHeader">
                ...
                <p className="companyReport">VAT Sales Register Report</p>
                <div className="date">
                <p>
                    From:{" "}
                    {format(
